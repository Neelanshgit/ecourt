...
public class Party {
	...
	public Party(String item_no, String khata_number, String area, String survey_no, String party_name,
	...
	public String toString() {
		return "Party [item_no=" + item_no + ", khata_number=" + khata_number + ", area=" + area + ", survey_no="
				+ survey_no + ", party_name=" + party_name + ", taluka_code=" + taluka_code + ", village_code="
				+ village_code + "]";
	}
